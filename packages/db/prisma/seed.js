...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    email = (_a = process.env.PILOT_EMAIL) !== null && _a !== void 0 ? _a : 'abdulla@aptask.com';
                ...
                case 1:
                    ...
                    return [4 /*yield*/, prisma.user.upsert({
                            where: { email: email },
                            update: { passwordHash: passwordHash, isAdmin: true, isActive: true },
                            create: {
                                email: email,
                ...
                case 2:
                    user = _b.sent();
                    console.log("Seeded user: ".concat(user.email, " (id=").concat(user.id, ", admin=").concat(user.isAdmin, ")"));
                    return [2 /*return*/];
            }
        });
    });
