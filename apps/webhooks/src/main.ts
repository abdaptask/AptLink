...
// Refactored to act as a lightweight event ingest sink enqueuing to BullMQ.
...
const webhookQueue = new Queue('telnyx-webhooks', {
...
// v0.10.99 — Telnyx Call Control voicemail observer. Enqueues CC events for background processing.
...
// ---------- Phase 5.6: TexML inbound flow (Synchronous callback) ----------
...
// ===========================================================================
// v0.10.119 - TeXML voicemail trial routes (Synchronous voice XML generation)
// ===========================================================================
...
// v0.10.119 - Recording-complete callback. Enqueues the VM processing.
...
// ---------- Phase 5.6: Voicemail recording webhook (Hosted VM) ----------
